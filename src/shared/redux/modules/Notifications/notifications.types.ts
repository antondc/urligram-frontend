...
interface ListsNotificationLoadRequestAction {
  type: typeof LISTS_NOTIFICATIONS_LOAD_REQUEST;
  payload: Partial<NotificationsState>;
}

interface ListsNotificationLoadSuccessAction {
  type: typeof LISTS_NOTIFICATIONS_LOAD_SUCCESS;
  payload: Partial<NotificationsState>;
}
interface ListsNotificationLoadFailureAction {
  type: typeof LISTS_NOTIFICATIONS_LOAD_FAILURE;
  payload: Partial<NotificationsState>;
}

interface ListsNotificationViewedRequestAction {
  type: typeof LISTS_NOTIFICATIONS_VIEWED_REQUEST;
  payload: Partial<NotificationsState>;
}

interface ListsNotificationViewedSuccessAction {
  type: typeof LISTS_NOTIFICATIONS_VIEWED_SUCCESS;
  payload: Partial<NotificationsState>;
}
interface ListsNotificationViewedFailureAction {
