    ...
    <div className="List">
        ...
        <AnimateHeight className="List-notification" mounted={showBanner} speed="fastest" ease={[1, 0.02, 0.83, 1.15]}>
            <CardItem className="List-notificationContent">
                <div className="List-notificationText">You were invited to this list as {listInvitationRole}: join it?
                </div>
                {acceptLoading ? (
            ...
            <div className="List-headerImages">
                    ...
                    <div className="List-headerImagesJoined">
                        {usersInThisList?.map((item) => (
                            <React.Fragment key={item?.id}>
                                <RenderInPortal>
                                    <Tooltip parentElementId={`List-${item?.id}}`} content={`@${item?.name}`}
                                             delay={2}/>
                                </RenderInPortal>
                                <A
                                    className={
                                    ...
                                    frontend
                                >
                                    <img className="List-headerImagesItemImage" src={item.image?.['200w']}
                                         alt={item.name}/>
                                </A>
                            </React.Fragment>
                        ))}
                ...
                {sessionUserListRole === 'admin' && (
                    <>
                        ...
                        <EditCircle className="List-iconRole List-iconAdmin" id="List-tooltipAdmin"
                                    onClick={onEditClick}/>
                    </>
                )}
