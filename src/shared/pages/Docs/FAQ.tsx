...
export const FAQ: React.FC = () => (
  <div className="Docs-section" id="faq">
    ...
    <p className="Docs-paragraph">
      Urligram is an online platform that allows users to store, share and manage URL resources. The goal is to provide a
    ...
    <p className="Docs-paragraph">
      There are two ways to use Urligram: you can search and browse public bookmarks, lists and users in the database; or
    ...
    <p className="Docs-paragraph">
      Urligram works as a website, but there is also an extension to save bookmarks without having Urligram site open: this is
    ...
    <p className="Docs-paragraph">Urligram is a social bookmarking tool. We consider the main benefits of Urligram to be:</p>
    ...
    <p className="Docs-paragraph">
      With Urligram you will never loose that article you came across while browsing, and your friends wont have any excuse
