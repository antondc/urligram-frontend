...
export const Glossary: React.FC = () => (
  <div className="Docs-section" id="glossary">
    ...
    <div id="visitor">
      <h4 className="Docs-h4">Visitor</h4>
    ...
    <div id="link">
      <h4 className="Docs-h4">Link</h4>
      <ul className="Docs-ul">
        <li className="Docs-li">
          The link is the representation of the URL in the database. Users are not aware of the concept of link: they
          only know about bookmarks
        </li>
        <li className="Docs-li">
    ...
    <div id="bookmark">
      <h4 className="Docs-h4">Bookmark</h4>
      <ul className="Docs-ul">
        ...
        <li className="Docs-li Docs-liSecondLevel">
          A private bookmark is only seen by the user that bookmarked it, except when is added to a private list: then
          all users within this list will see it.
        </li>
        <li className="Docs-li Docs-liSecondLevel">
          A public bookmark can be seen by all users. A public bookmark within a private list will still be seen by
          other users.
        </li>
    ...
    <div id="follower">
      <h4 className="Docs-h4">Follower</h4>
      <ul className="Docs-ul">
        <li className="Docs-li">
          A follower is a user that listen to some specific actions of another user, e.g., the resources that another
          user adds to his lists.
        </li>
      </ul>
    </div>
    <div id="extension">
