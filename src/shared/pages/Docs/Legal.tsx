...
export const Legal: React.FC<Props> = ({ domain, contactEmail, appName }) => (
  <div className="Docs-section" id="legal">
    ...
    <div id="privacy-policy">
      ...
      <p className="Docs-paragraph">
        This Policy will explain how Urligram collects, uses and disclosure the personal data we collect from you when you
        use our website.
      </p>
      <p className="Docs-paragraph">
      ...
      <p className="Docs-paragraph">
        You are able to use Urligram anonymously, the only data we collect is the working email address. Your email address
      ...
      <ul className="Docs-ul">
        ...
        <li className="Docs-li">
          You have the right to request that Urligram transfer the data that we have collected to another organization or
          directly to you.
        </li>
      </ul>
      <p className="Docs-paragraph">
