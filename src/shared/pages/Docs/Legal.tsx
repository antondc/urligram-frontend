...
export const Legal: React.FC<Props> = ({ domain, contactEmail, appName }) => (
  <div className="Docs-section" id="legal">
    ...
    <p className="Docs-paragraph">
      This Disclaimer is a legally binding agreement between you —«User», «you» or «your»— and this Website operator and
      Mobile Application developer —«Operator», «we», «us» or «our»—.
    </p>
    <p className="Docs-paragraph">
      If you are entering into this agreement on behalf of a business or other legal entity, you represent that you have
      the authority to bind such entity to this agreement, in which case the terms «User», «you» or «your» shall refer
      to such entity.
    </p>
    <p className="Docs-paragraph">
      If you do not have such authority, or if you do not agree with the terms of this agreement, you must not accept
      this agreement and may not access and use the Services. By accessing and using the Services, you acknowledge that
      you have read, understood, and agree to be bound by the terms of this Disclaimer.
    </p>
    <p className="Docs-paragraph">
      You acknowledge that this Disclaimer is a contract between you and the Operator, even though it is electronic and
      is not physically signed by you,and it governs your use of the Services.
    </p>
    <h4 className="Docs-h4">Representation</h4>
    <p className="Docs-paragraph">
      Any views or opinions represented on the Services belong solely to the content creators and do not represent those
      of people,institutions or organizations that the Operator or creators may or may not be associated with in
    ...
    <p className="Docs-paragraph">
      Website is not responsible for any incorrect or inaccurate Content posted on the Website or in connection with the
      Services provided. Profiles created and posted by Users of the Website may contain links to other websites. The
      Website is not responsible for the Content, accuracy or opinions expressed on such websites, and such websites are
      in no way investigated, monitored or checked for accuracy or completeness by the Website.Inclusion of any linked
      website on the Website does not imply approval or endorsement of the linked website by the Website. When you
    ...
    <p className="Docs-paragraph">
      While we have made every attempt to ensure that the information contained on the Services is correct, the Operator
      is not responsible for any errors or omissions, or for the results obtained from the use of this information. All
      information on the Services is provided «as is»,with no guarantee of completeness, accuracy, timeliness or of the
      results obtained from the use of this information, and without warranty of any kind,express or implied. In no
      event will the Operator, or its partners, employees or agents, be liable to you or anyone else for any decision
      made or action taken in reliance on the information on the Services, or for any consequential,special or similar
      damages, even if advised of the possibility of such damages.Information contained on the Services are subject to
      change at any time and without warning.
    </p>
    <h4 className="Docs-h4">Changes and amendments</h4>
    <p className="Docs-paragraph">
      We reserve the right to modify this Disclaimer or its terms related to the Services at any time at our discretion.
      When we do, we will revise the updated date at the bottom of this page. We may also provide notice to you in other
    ...
    <p className="Docs-paragraph">
      ...
      unless otherwise specified. Your continued use of the Services after the effective date of the revised Disclaimer
      —or such other act specified at that time— will constitute your consent to those changes.
    </p>
    ...
    <p className="Docs-paragraph">
      ...
      Disclaimer, you are not authorized to access or use the Services. This disclaimer was created with the disclaimer
      generator.
    </p>
    ...
    <h3 className="Docs-h3" id="privacy-policy">
      Privacy Policy
    </h3>
    <p className="Docs-paragraph">
      This Policy will explain how Linking collects, uses and disclosure the personal data we collect from you when you
      use our website.
    </p>
    <p className="Docs-paragraph">
      We use your Personal Information for providing and improving the Services. By using the Service, you agree to the
      collection and use of information in accordance with this policy.
    </p>
    <p className="Docs-paragraph">
      You are able to use Linking anonymously, the only data we collect is the working email address. Your email address
    ...
    <p className="Docs-paragraph">
      ...
      version, the pages of our Services that you visit, the time and date of your visit, the time spent on those pages
      and other statistics.
    </p>
    <p className="Docs-paragraph">
      Cookies are files with small amount of data, which may include an anonymous unique identifier. Cookies are sent to
      your browser from a web site and stored on your browser’s memory.
    </p>
    <p className="Docs-paragraph">
