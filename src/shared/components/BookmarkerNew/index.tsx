...
import { BookmarkerNew as BookmarkerNewUi } from './BookmarkerNew';
...
const BookmarkerNew: React.FC<Props> = ({ className, listId, bookmarkId, onBookmarked }) => {
