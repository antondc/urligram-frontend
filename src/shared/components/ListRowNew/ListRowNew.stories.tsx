...
import { ListRowNewSkeleton } from './ListRowNewSkeleton';

export default {
  component: ListRowNew,
  title: 'ListRowNew',
...
export const Default: React.FC = () => (
  <ProviderWrapper>{!knobs.skeleton() ? <ListRowNew {...props} /> : <ListRowNewSkeleton {...props} />}</ProviderWrapper>
);
